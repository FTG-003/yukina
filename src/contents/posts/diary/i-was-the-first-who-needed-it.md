---
title: "I Was the First One Who Needed It."
description: "I built a tool against AI frenzy while I was inside the frenzy. The product is the sediment of that contradiction."
...
<p align="center">
  <img src=" /banner/12-a.webp" alt="App Obliqo alla sera" />
</p> 
...
The extension is [live on the Chrome Web Store](https://chromewebstore.google.com/detail/iijneekhjjpfhdcmbclmlgaemhbpbjfk). It activates inside the tab where you are writing — Gmail, a PR description, the body of a post — and reads the draft before you send it. The webapp keeps living at [obliqo.pyragogy.org](https://obliqo.pyragogy.org). The extension is the same thing, brought to where the work happens.
