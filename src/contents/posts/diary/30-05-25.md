...
Maybe it’s habit. Maybe it’s stubbornness. Maybe it’s because I simply don’t know how to _not_ build and document—even when the audience, for now, is an empty room.
...
You learn by _doing_, even when no one’s watching, because real knowledge grows in hidden places, and only later finds the light.
