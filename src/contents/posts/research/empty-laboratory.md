...
*For the mathematicians who stayed silent:*

Let S(t) be the resonance function. Let K(t) be the knowledge generated by its absence.

It is conjectured — but not yet proven — that:

> **lim S(t) = 0 ⇒ lim K(t) ≫ 0**

When the world withdraws, the residue is not zero. It is the square of the velocity of withdrawal.

You already knew this. You just hadn't seen it written in a philosophical text.

Now you have.

*A quel che non torna, si torna.*